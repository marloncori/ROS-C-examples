/*
 The robot Husarion was used the lesson, #112 liveclass, part2
roslaunch rosbot_gazebo cpp_wall.launch */

#include "rosbot_control/rosbot_class.h"
#include "geometry_msgs/Twist.h"
#icnlude "nav_msgs/Odometry.h"
